...
DISPLAY=:1 DISPLAY=:1.0 chromium-browser --no-sandbox --autoplay-policy=no-user-gesture-required --incognito --disable-gpu --user-data-dir=/tmp/test  --window-position=0,0 --window-size=1280,720 "--app=${1}"
sleep 1
